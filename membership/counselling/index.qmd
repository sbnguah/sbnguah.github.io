...
description: "Counselling station for WACP and GCPS examinations" 
date: 2025-08-01
toc: true
...
+------------------------------------------+------------------------------------------+-----------+
| **1. Acknowledge Emotions and Provide    | -   Recognizes caregiver’s emotional     | 2         |
| Reassurance**                            |     state **(1 mark)**\                  |           |
|                                          | -   Offers reassurance and empathetic    |           |
|                                          |     support **(1 mark)**                 |           |
+------------------------------------------+------------------------------------------+-----------+
| **2. Explanation of Diagnosis**          | \- States the name of the condition and  | 3         |
|                                          | that it's congenital **(1 mark)**\       |           |
|                                          | - Provides simplified explanation of the |           |
|                                          | cardiac defect (e.g., hole, mixed blood, |           |
|                                          | reduced oxygen) **(2 marks)**            |           |
+------------------------------------------+------------------------------------------+-----------+
| **3. Description of Symptoms**           | \- Identifies at least three common      | 3         |
|                                          | symptoms (cyanosis, fatigue, feeding     |           |
|                                          | issues, blue spells) **(1 mark each, max |           |
|                                          | 3)**                                     |           |
+------------------------------------------+------------------------------------------+-----------+
| **4. Immediate Home Care Advice**        | \- Advises on keeping the child calm and | 3         |
|                                          | managing crying **(1 mark)** - Describes |           |
|                                          | knee-chest/squatting position during     |           |
|                                          | blue spells **(1 mark)**\                |           |
|                                          | - Advises to seek medical help during    |           |
|                                          | emergencies **(1 mark)**                 |           |
+------------------------------------------+------------------------------------------+-----------+
| **5. Treatment and Prognosis**           | -   States that the condition is         | 3         |
|                                          |     treatable **(1 mark)**\              |           |
|                                          | -   Explains role and timing of          |           |
|                                          |     corrective surgery **(1 mark)**\     |           |
|                                          | -   Refers to the availability of        |           |
|                                          |     surgical centers (e.g., Korle Bu)    |           |
|                                          |     **(1 mark)**                         |           |
+------------------------------------------+------------------------------------------+-----------+
| **6. Addressing Fears and                | -   Counters fear of imminent death with | 3         |
| Misconceptions**                         |     reassurance **(1 mark)**\            |           |
|                                          | -   Debunks myths about curses or        |           |
|                                          |     spiritual causes **(1 mark)**\       |           |
|                                          | -   Clarifies that the caregiver did     |           |
|                                          |     nothing wrong **(1 mark)**           |           |
+------------------------------------------+------------------------------------------+-----------+
| **7. Practical/Financial Support**       | \- Mentions possible financial           | 1         |
|                                          | challenges **(0.5 mark)**                |           |
|                                          |                                          |           |
|                                          | \- Suggests options: social              |           |
|                                          | welfare/NGOs/church/community help       |           |
|                                          | **(0.5 mark)**                           |           |
+------------------------------------------+------------------------------------------+-----------+
| **8. Importance of Follow-Up**           | \- Emphasizes ongoing outpatient care    | 1         |
|                                          | and monitoring **(0.5 mark)**\           |           |
|                                          | - Lists at least one danger sign to      |           |
|                                          | watch for **(0.5 mark)**                 |           |
+------------------------------------------+------------------------------------------+-----------+
| **9. Encouragement and Hope**            | \- Ends with positive outlook and        | 1         |
